package ar.com.rodrilapenta.mybatistest.gui;
...
import ar.com.rodrilapenta.mybatistest.gui.paneles.PanelQueryStats;
import ar.com.rodrilapenta.mybatistest.service.MainService;
import ar.com.rodrilapenta.mybatistest.util.Util;
...
public class MainFrame extends JFrame {
	...
	public MainFrame(final MainService service, Boolean useHibernate) {
		...
		queryGenericaMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*PanelQueryStats panel = new PanelQueryStats(service.getDao().getGenericDAO());
				setContentPane(panel);*/
				CardLayout cardLayout = (CardLayout) getContentPane().getLayout();
				cardLayout.show(getContentPane(), "query");
			}
		});
		...
		panel.add(new PanelQueryStats(service.getDao().getGenericDAO()), "query");
		setContentPane(panel);
	}
}